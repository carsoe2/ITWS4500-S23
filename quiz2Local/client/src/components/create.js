...
export default function Create() {
    ...
    function onSubmit(e) {
        ...
        if (newPerson.api == "0") {
            fetch("http://localhost:3000/quiz2/add", {
                method: "POST",
                headers: {
            ...
            fetch("http://localhost:3000/quiz2/addFamous", {
                method: "POST",
                headers: {
                    "Content-Type": "application/json",
                },
            ...
            fetch("http://localhost:3000/quiz2/addCelebrity", {
                method: "POST",
                headers: {
                    "Content-Type": "application/json",
                },
            ...
            fetch("http://localhost:3000/quiz2/addHero", {
                method: "POST",
                headers: {
                    "Content-Type": "application/json",
                },
            ...
            fetch("http://localhost:3000/quiz2/addActor", {
                method: "POST",
                headers: {
                    "Content-Type": "application/json",
                },
