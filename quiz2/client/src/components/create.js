...
export default function Create() {
    ...
    function onSubmit(e) {
        ...
        if (newPerson.api == "0") {
            fetch("https://carsoe2.eastus.cloudapp.azure.com/node/quiz2/add", {
                method: "POST",
                headers: {
            ...
            fetch("https://carsoe2.eastus.cloudapp.azure.com/node/quiz2/addFamous", {
                method: "POST",
                headers: {
                    "Content-Type": "application/json",
                },
            ...
            fetch("https://carsoe2.eastus.cloudapp.azure.com/node/quiz2/addCelebrity", {
                method: "POST",
                headers: {
                    "Content-Type": "application/json",
                },
            ...
            fetch("https://carsoe2.eastus.cloudapp.azure.com/node/quiz2/addHero", {
                method: "POST",
                headers: {
                    "Content-Type": "application/json",
                },
            ...
            fetch("https://carsoe2.eastus.cloudapp.azure.com/node/quiz2/addActor", {
                method: "POST",
                headers: {
                    "Content-Type": "application/json",
                },
